  ...
  main.innerHTML = `<article data-index="0" data-status="visible">
                  <div class="article-main-section article-section">
                      <div>
                          <div>
                              ...
                              <div>
                                  <input class="student-id" value="${data.id}" onkeyup="idIndex()" onclick="inputFcs()"
                                      onfocusout="inputFcsOut(event, currId)">
                              </div>
                  ...
                  <div class="article-title-section article-section">
                      <div class="article-title">
                          ...
                          <input class="article-heading-icon" value="${data.roll}" onkeyup="rollIndex()" onclick="inputFcs()"
                              onfocusout="inputFcsOut(event, currRoll)">
                      </div>
                  </div>
